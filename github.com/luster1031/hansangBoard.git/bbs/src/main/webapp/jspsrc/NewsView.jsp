	...
	<table>
		...
		%>
			<tr>
				...
				<td>
					<a href ="/bbs/main?action=delete&NID=<%= vo.getNID() %>&writer=<%=vo.getWriter()%>&name=hanna">
					<img src = "/mvc/images/delete.png" width = '30'></a></td>
				<td>
					<a href = '/bbs/jspsrc/update.jsp?NID=<%=vo.getNID()%>'>
					<img src = "/mvc/images/edit.png" width = '30'></a>
				</td>
				<!-- 
					<img onclick="displayUpdateForm('<%= vo.getNID() %>')" 
